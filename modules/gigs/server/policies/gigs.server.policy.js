...
/**
 * Check If Gigs Policy Allows
 */
exports.isAllowed = function(req, res, next) {
  var roles = (req.user) ? req.user.roles : ['guest'];

  // If an gig is being processed and the current user created it then allow any manipulation
  if (req.gig && req.user && req.gig.userId === req.user.id) {
    return next();
  }
